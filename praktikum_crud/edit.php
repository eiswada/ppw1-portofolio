...
<head>
    ...
    <style>
        ...
        .current-photo { text-align: center; margin: 15px 0; padding: 15px; background-color: #f8f9fa; border-radius: 5px; }
        .current-photo img { max-width: 200px; max-height: 200px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); }
        .photo-actions { margin-top: 10px; }
        .photo-actions label { font-weight: normal; color: #dc3545; cursor: pointer; }
                ...
                <?php if ($current_foto && file_exists("uploads/mahasiswa/" . $current_foto)): ?>
                    <div class="current-photo">
                        ...
                        <div class="photo-actions">
                            <label><input type="checkbox" name="hapus_foto" value="1"> 🗑️ Hapus foto ini</label>
                        </div>
                    </div>
                <?php else: ?>
