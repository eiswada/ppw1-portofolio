...
$search_query = !empty($search)
    ? "WHERE nim LIKE '%$search%' OR nama LIKE '%$search%' OR jurusan LIKE '%$search%' OR email LIKE '%$search%'"
    : '';

// Hitung total data
$count_result = mysqli_query($conn, "SELECT COUNT(*) as total FROM mahasiswa $search_query");
$total_data   = mysqli_fetch_assoc($count_result)['total'];
$total_pages  = ceil($total_data / $limit);

// Ambil data dengan pagination
$result = mysqli_query($conn, "SELECT * FROM mahasiswa $search_query ORDER BY id DESC LIMIT $limit OFFSET $offset");
?>
<!DOCTYPE html>
<html lang="id">
...
<body>
    <div class="container">
        ...
        <div class="stats">
            ...
            <div>Halaman <?php echo $page; ?> dari <?php echo max(1, $total_pages); ?></div>
        </div>
